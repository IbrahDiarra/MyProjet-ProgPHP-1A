               ...
               if($mdp2 != $mdp1){
                   ...
                   $error = "Les Mots de passes sont différents !";
                       ...
                       if($req){
                           ...
                           //connexion
                           $_SESSION['messageuser'] = "Mise à jour effectuée avec succès !" ;
                           echo "<script> window.location.href='index.php?page=my_compte';</script>";
                       }else {
                           //si non
...
<section class="m-5 ps-5 pt-3 pe-5 pb-5">
                <div class="row pt-2 ps-5 cardss mt-5"  >
                            ...
                            <div class="col-lg-9 bg-white" style="border-radius: 0px 20px 20px 0px;">
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-8">
                                            <?php if(isset($_SESSION['messageuser'])):?>
                                                <div class='toast show'>
                                                    <div class='toast-header text-center'>
                                                        <strong class='me-auto text-dark text-center' style="font-family:'Patua One';"><?php echo $_SESSION['messageuser'] ;?></strong>
